...
const TarifasRecoleccionEntrega = ({ onVolverClick }) => {
  return (
    <div className="max-w-screen-xl mx-auto bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-lg">
      ...
      <table className="w-full border border-amber-500 mt-2 md:mt-4">
        <thead>
          <tr className="bg-amber-500 text-white text-center">
      ...
      <table className="w-full border border-amber-500">
        <thead>
          <tr className="bg-amber-500 text-white text-center">
      ...
      <div className="w-full mt-4">
        <button className="w-full h-10 bg-amber-500 rounded-md text-center text-white text-lg font-bold font-['Inter']">
          Listo
        </button>
        <button
