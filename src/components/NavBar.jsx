    ...
    <>
      <div
        className={`md:hidden flex flex-col items-center ${
          navbarFixed
            ? "fixed top-0 left-0 right-0 bg-amber-500 shadow-md w-full transition-transform transform translate-y-0"
            : "relative bg-amber-500 w-full"
        }`}
        style={{ zIndex: 1000 }}
      >
        ...
        {showMenu && (
          <nav
            className={`bg-amber-500 text-white ${mobileMenuStyles} flex-1 mb-10`}
          >
            <a
              href="#nosotros"
            ...
            <a
              href="#"
              className={`${
                selectedOption === "sucursales" ? "underline" : ""
              }`}
              style={{ fontFamily: "'fuente', sans-serif" }}
            >
              Sucursales
