      ...
      {!mostrarTarifa && (
        <div className="w-full flex flex-col justify-center items-center p-4">
          <div className="w-full max-w-screen-xl mx-auto">
            <div className="p-4 bg-white rounded-lg shadow-md">
              <div className="mb-4">
                ...
                <select
                  className="w-full h-10 bg-amber-500 bg-opacity-25 rounded-md"
                ...
                <select
                  className="w-full mt-2 h-10 bg-amber-500 bg-opacity-25 rounded-md"
              ...
              <div className="mb-4">
                ...
                <select className="w-full h-10 bg-amber-500 bg-opacity-25 rounded-md">
          ...
          <div className="w-full mt-4">
            <button
              className="w-full h-10 bg-amber-500 rounded-md text-center text-white text-lg font-bold font-['Inter']"
